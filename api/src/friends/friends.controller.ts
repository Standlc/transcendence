...
export class FriendsController {
  ...
  @ApiCreatedResponse({
    description:
      "Friend request sent, but this endpoint will return 'Friend added' if you tried to request someone who already request you",
    schema: {
      type: 'string',
  ...
  @ApiUnprocessableEntityResponse({
    description:
      'This status is return if you request someone who is already your friend, yourself or you already sent a request.',
  })
  @ApiNotFoundResponse({
  ...
  @ApiQuery({
    ...
    required: true,
    description:
      'The user id of who issue the friend request you wish to accept.',
  })
  @Post('accept')
  async acceptRequest(
    @Request() req,
  ...
  @ApiQuery({
    ...
    required: true,
    description:
      'The user id of who issue the friend request you wish to deny.',
  })
  @Delete('deny')
  async deleteRequest(
    @Request() req,
  ...
  @ApiQuery({
    ...
    required: false,
    description:
      'The user id of who you want to get a friend list, if not specified, the friend list of yourself is returned. ',
  })
  @Get()
  async findAllFriends(
    ...
    const friends = await this.friendsService.getUserFriendsWithConversationId(
      userId,
      id,
    );
    return friends;
